...
TOOL_NAME_LIST = ['create-sbatch', 'create-cellranger']
...
def generate_cli_dictionary() -> Dict[str, AbstractCLI]:
    ...
    for tool_name in TOOL_NAME_LIST:
        ...
        module_cli_str_list = ["pybiocmtools", tool_name.replace("-", "_"), "cli"]
...
def get_populated_argparser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="pybiocmtools",
        description="pybiocmtools is a collection of tools to help in bioinformatics analyses.",)
    ...
    subparsers = parser.add_subparsers(
        title="sub-commands",
        description="valid pybiocmtools commands",
        dest="tool")

    for tool_name in TOOL_NAME_LIST:
        module_argparse_str_list = ["pybiocmtools", tool_name.replace("-", "_"), "argparser"]
